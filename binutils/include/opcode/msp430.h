...
enum msp430_expp_e
{
  ...
  MSP_EXPP_LLO,		/* Equivalent to MSP_EXPP_LO.  */
  MSP_EXPP_LHI,		/* Equivalent to MSP_EXPP_HI.  */
  MSP_EXPP_HLO,		/* Extract 3rd word from expression.  */
  MSP_EXPP_HHI,		/* Extract 4th word from expression.  */
};
...
struct msp430_operand_s
{
  ...
  enum msp430_expp_e expp;	/* For when the operand is a constant expression, the part of
