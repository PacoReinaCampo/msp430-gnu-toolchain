...
void test_a (int w, int p, double x)
{
  ...
  T1 ("%*.a", w);     /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T1 ("%*.0a", w);    /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T1 ("%*.1a", w);    /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T1 ("%*.2a", w);    /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */

  T1 ("%.*a",  p);    /* { dg-warning "writing between 3 and 2147483658 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32778 bytes" "" { target int16 } .-1 } */
  T1 ("%1.*a", p);    /* { dg-warning "writing between 3 and 2147483658 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32778 bytes" "" { target int16 } .-1 } */
  T1 ("%2.*a", p);    /* { dg-warning "writing between 3 and 2147483658 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32778 bytes" "" { target int16 } .-1 } */
  T1 ("%3.*a", p);    /* { dg-warning "writing between 3 and 2147483658 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32778 bytes" "" { target int16 } .-1 } */

  T2 ("%*.*a", w, p); /* { dg-warning "writing between 3 and 2147483658 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32778 bytes" "" { target int16 } .-1 } */
}
...
void test_e (int w, int p, double x)
{
  ...
  T1 ("%*.e", w);     /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T1 ("%*.0e", w);    /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T1 ("%*.1e", w);    /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T1 ("%*.2e", w);    /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */

  T1 ("%.*e",  p);    /* { dg-warning "writing between 3 and 2147483655 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32775 bytes" "" { target int16 } .-1 } */
  T1 ("%1.*e", p);    /* { dg-warning "writing between 3 and 2147483655 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32775 bytes" "" { target int16 } .-1 } */
  T1 ("%2.*e", p);    /* { dg-warning "writing between 3 and 2147483655 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32775 bytes" "" { target int16 } .-1 } */
  T1 ("%3.*e", p);    /* { dg-warning "writing between 3 and 2147483655 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32775 bytes" "" { target int16 } .-1 } */

  T2 ("%*.*e", w, p); /* { dg-warning "writing between 3 and 2147483655 bytes" "" { target int32 } } */
		      /* { dg-warning "writing between 3 and 32775 bytes" "" { target int16 } .-1 } */
}
...
void test_f (int w, int p, double x)
{
  ...
  T1 ("%*.1f", w);          /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
			    /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T1 ("%*.2f", w);          /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
			    /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
...
void test_a_va (va_list va)
{
  ...
  T ("%*.a");       /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		    /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T ("%*.0a");      /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		    /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T ("%*.1a");      /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		    /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */
  T ("%*.2a");      /* { dg-warning "writing between 3 and 2147483648 bytes" "" { target int32 } } */
		    /* { dg-warning "writing between 3 and 32768 bytes" "" { target int16 } .-1 } */

  T ("%.*a");       /* { dg-warning "writing between 3 and 2147483658 bytes" "" { target int32 } } */
		    /* { dg-warning "writing between 3 and 32778 bytes" "" { target int16 } .-1 } */
  T ("%1.*a");      /* { dg-warning "writing between 3 and 2147483658 bytes" "" { target int32 } } */
		    /* { dg-warning "writing between 3 and 32778 bytes" "" { target int16 } .-1 } */
  T ("%2.*a");      /* { dg-warning "writing between 3 and 2147483658 bytes" "" { target int32 } } */
		    /* { dg-warning "writing between 3 and 32778 bytes" "" { target int16 } .-1 } */
...
void test_e_va (va_list va)
{
  ...
  T ("%.*e");       /* { dg-warning "writing between 3 and 2147483655 bytes" "" { target int32 } } */
		    /* { dg-warning "writing between 3 and 32775 bytes" "" { target int16 } .-1 } */
  T ("%1.*e");      /* { dg-warning "writing between 3 and 2147483655 bytes" "" { target int32 } } */
		    /* { dg-warning "writing between 3 and 32775 bytes" "" { target int16 } .-1 } */
