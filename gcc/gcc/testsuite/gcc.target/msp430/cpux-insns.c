...
char ATTR_EITHER eqi1, eqi2, eqi3, eqi4, eqi5;
int ATTR_EITHER ehi1, ehi2, ehi3, ehi4, ehi5;
long ATTR_EITHER esi1, esi2, esi3, esi4, esi5;

/* Only use these to generate CPU insns.  */
char ATTR_LOWER lqi1, lqi2, lqi3, lqi4, lqi5;
int ATTR_LOWER lhi1, lhi2, lhi3, lhi4, lhi5;
long ATTR_LOWER lsi1, lsi2, lsi3, lsi4, lsi5;

/* Use these freely, they are not scanned for in the assembler output.  */
char qi1, qi2, qi3, qi4, qi5;
int hi1, hi2, hi3, hi4, hi5;
long si1, si2, si3, si4, si5;
